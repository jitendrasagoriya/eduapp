...
public class SecureTokenGenerator {
	...
	public static final int SECURE_TOKEN_LENGTH = 256/6;
	...
	public static String getToken(String userName) {
		String[] userId = Base64BasicEncryption.encoding(userName).split("=");
		String token = nextToken() +"-"+userId[0].toUpperCase()+"-"+System.currentTimeMillis();
		return token;
	}
	
	public static void main(String[] args) {
		String token =getToken("Jitendra Sagoriya");
